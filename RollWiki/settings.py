"""
Django settings for RollWiki project.
...
SECRET_KEY = 'keqpii^w_#8=wln5auhvk(((t0495f@5$4-0kc*2+-in=_4+*q'
...
WSGI_APPLICATION = 'RollWiki.wsgi.application'
